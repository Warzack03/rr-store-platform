...
export function CheckoutForm({ shippingCents }: { shippingCents: number }) {
  ...
  return <form className="grid gap-8 lg:grid-cols-[1fr_23rem]" onSubmit={submit}>
    <div className="space-y-7">
      ...
      <label className="flex items-start gap-3 border border-white/12 p-5 text-sm leading-6 text-white/75"><input className="mt-1 size-4 accent-[#ffd46f]" name="legalAccepted" required type="checkbox" />He leído y acepto las condiciones de compra y la política de privacidad.</label>
